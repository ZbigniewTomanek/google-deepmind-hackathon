...
| 8 | CLI-Reproducible E2E Smoke Tests | DONE | 6-step E2E script: ingest→wait→ontology→graph→recall→isolation, compatible with run_e2e.sh runner |

- **Last stage completed**: Stage 8 — CLI-Reproducible E2E Smoke Tests
